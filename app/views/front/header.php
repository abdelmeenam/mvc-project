...
<!-- Bootstrap core CSS -->
<link href=" <?= CSSPATH; ?>front/css/bootstrap.css" rel="stylesheet">

<!-- FontAwesome Icons core CSS -->
<link href="<?= CSSPATH; ?>front/css/font-awesome.min.css" rel="stylesheet">

<!-- Custom styles for this template -->
<link href="<?= CSSPATH; ?>front/style.css" rel="stylesheet">

<!-- Responsive styles for this template -->
<link href="<?= CSSPATH; ?>front/css/responsive.css" rel="stylesheet">

<!-- Colors for this template -->
<link href="<?= CSSPATH; ?>front/css/colors.css" rel="stylesheet">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown has-submenu">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Categories From Backend</a>

                                <ul class="dropdown-menu" aria-labelledby="dropdown02">
                                    <?php foreach ($data as $cat) :  ?>
                                        <li><a class="dropdown-item" href="blog-author.html"></a><?= $cat['name'] ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            </li>
                            <li class="nav-item">
