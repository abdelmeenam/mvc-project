...
<!-- Core JavaScript
    ================================================== -->
<script src="<?= CSSPATH; ?>front/js/jquery.min.js"></script>
<script src="<?= CSSPATH; ?>front/js/tether.min.js"></script>
<script src="<?= CSSPATH; ?>front/js/bootstrap.min.js"></script>
<script src="<?= CSSPATH; ?>front/js/custom.js"></script>
